...
public class PurchaseToProductMappingDAO {
      ...
      public int add(PurchaseToProductMappingTable purchase) {
            String sql = "INSERT INTO purchasetoproductmapping (purchaseId, productId, quantity) VALUES (:purchaseId, :productId, :quantity)";
      ...
      public int deleteByPurchaseId(int purchaseId) {
            String sql = "DELETE FROM purchasetoproductmapping WHERE purchaseId = :purchaseId";
            SqlParameterSource paramSource = new MapSqlParameterSource()
      ...
      public int deleteByProductId(int productId) {
            String sql = "DELETE FROM purchasetoproductmapping WHERE productId = :productId";
            SqlParameterSource paramSource = new MapSqlParameterSource()
      ...
      public Optional<PurchaseToProductMappingTable> get(int id) {
            String sql = "SELECT * FROM purchasetoproductmapping WHERE id = :id";
            SqlParameterSource paramSource = new MapSqlParameterSource()
                  .addValue("id", id);
      ...
      public List<PurchaseToProductMappingTable> getByPurchaseId(int purchaseId) {
            String sql = "SELECT * FROM purchasetoproductmapping WHERE purchaseId = :purchaseId";
            SqlParameterSource paramSource = new MapSqlParameterSource()
                  .addValue("purchaseId", purchaseId);
      ...
      public List<PurchaseToProductMappingTable> getByProductId(int productId) {
            String sql = "SELECT * FROM purchasetoproductmapping WHERE productId = :productId";
            SqlParameterSource paramSource = new MapSqlParameterSource()
                  .addValue("productId", productId);
            return jdbcTemplate.query(sql, paramSource, new BeanPropertyRowMapper<>(PurchaseToProductMappingTable.class));
      }
      ...
      public List<PurchaseToProductMappingTable> getAll() {
            String sql = "SELECT * FROM purchasetoproductmapping";
            SqlParameterSource paramSource = new MapSqlParameterSource();
            return jdbcTemplate.query(sql, paramSource, new BeanPropertyRowMapper<>(PurchaseToProductMappingTable.class));
      }
